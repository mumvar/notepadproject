...
# defining function for open button
def opening_file():
    ...
    root.title(f"THY NOTEPAD - {file_location}")

# defining function for save button
def saving_file():
...
root = tk.Tk() # assigning variable for window
root.title("THY NOTEPAD")
...
frame_button = tk.Frame(root, relief=tk.RAISED, bd = 6)
